  ...
  return (
    ...
    >
        ...
        <div style={{display: 'flex', color: 'white', marginTop: 10 }}>
            <div style={{fontSize: '8rem', fontWeight: 900, marginTop: 10,fontFamily: 'Zelda-DemiBold'}}>10</div>
            ...
            {days.map(() => {
                ...
                >
                    ...
                    <div style={{display: 'flex', color: 'white' }}>
                        <div style={{fontSize: '1.5rem', fontWeight: 'bold', marginTop: 3, fontFamily: 'Zelda-DemiBold'}}>10</div>
